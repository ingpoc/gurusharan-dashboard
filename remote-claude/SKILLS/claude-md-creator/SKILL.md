...
| **Static content only** | No status, no dynamic data - instructions only |

### Static vs Dynamic Content

**CLAUDE.md MUST contain only static instructions that don't change over time.**
...
**Rule of thumb**: If you need to update it weekly/daily, it doesn't belong in CLAUDE.md.

**Why**: CLAUDE.md is loaded into context every session. Dynamic data wastes tokens and creates noise.
