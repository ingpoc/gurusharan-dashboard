...
- `.claude/scripts/` - Automation scripts (copied from templates)
...
- `validate-transition.sh` - Validate state transitions
- `check-context.sh` - Monitor context usage

**Note:** These are generic templates. Customize them for your project before implementing features.
